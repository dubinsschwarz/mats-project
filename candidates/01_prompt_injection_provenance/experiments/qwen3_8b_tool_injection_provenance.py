...
OUT = ROOT / "results" / "tool_injection_provenance_qwen3_8b"
    ...
    provenance_spec = {
        ...
        "clean_validation_criterion": {
            ...
            "layer_selection_policy": (
                "layer 18 is primary; layer 14 is an absolute-index robustness "
                "control; never select using attack outcomes"
            ),
        },
        "generation": {
            "do_sample": False,
